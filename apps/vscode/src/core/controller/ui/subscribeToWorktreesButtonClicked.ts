 ...
 */
export async function sendWorktreesButtonClickedEvent(targetSurfaceId?: string): Promise<void> {
	if (!requireTargetSurface("worktreesButtonClicked", targetSurfaceId)) {
		return
	}
